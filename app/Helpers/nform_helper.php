...
function input_text($pristine, $id, $a, $b, $c = '', $d = '')
{
    if(!is_array($c)){
        ...
        if(is_array($b)){
            return '<input type="text" required data-pristine-required-message="'.$pristine.' " id="'.$id.'" name="' . $a . '" value=\'' . $b[0] . '\' class="form-control' . $c . '"' . $d . '>' . "\n";
        }
        else{
            return '<input type="text" required data-pristine-required-message="'.$pristine.' " id="'.$id.'" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . '>' . "\n";
        }
    }
    else{
        $set='';
        ...
        $c=$set;
        if(is_array($b)){
            return '<input type="text" required data-pristine-required-message="'.$pristine.' " id="'.$id.'" name="' . $a . '" value=\'' . $b . '\' '.$c.'>' . "\n";
        }
        else{
            return '<input type="text" required data-pristine-required-message="'.$pristine.' " id="'.$id.'" name="' . $a . '" value="' . $b . '" '.$c.'>' . "\n";
        }
...
function input_file($a, $b, $c = '', $d = '')
{
    ...
    return '<input type="file" name="' . $a . '" value="' . $b . '" class="image-preview-filepond' . $c . '"' . $d . '>' . "\n";
}
...
function input_email($a, $b, $c = '', $d = '')
{
    ...
    return '<input type="email" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '"' . $d . '>' . "\n";
}
...
function input_hidden($m, $a, $b, $c = '')
{
    ...
    if(!is_array($c)){
        ...
        return '<input type="hidden" id="' . $m . '" name="' . $a . '" value="' . $b . '" class="form-control' . $c . '">' . "\n";
    }
    else{
        $set='';
        foreach ($c as $key => $value) {
        ...
        $c=$set;
        return '<input type="hidden" id="' . $m . '" name="' . $a . '" value="' . $b . '" '.$c.'>' . "\n";
...
function radio($a, $b, $c = '', $d = '', $e = '')
{
    ...
    return '<input type="radio" name="' . $a . '" value="' . $b . '" class="' . $d . '"' . $e . '' . $checked . '>';
}
function checkbox($a, $b, $c = '', $d = '', $e = '')
{
    ...
    return '<input type="checkbox" name="' . $a . '" value="' . $b . '" class="' . $d . '"' . $e . '' . $checked . '>';
}
...
function info_info($a)
{
    return _info_template($a, 'alert-info');
}
